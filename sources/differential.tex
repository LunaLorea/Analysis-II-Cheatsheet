...
\subsection{Taylorpolynome}
  \definition{3.7.1}{Das k-te Taylorpolynom von f bei y}
    ...
    \end{array} \]
  \additional{Nützliche Taylorreihen}
  Für \(k\neq\infty\) addiere den Fehler \(o(||x-y||^2)\)
  \[\begin{array}{lll}
    \sin(x) & = \lim\limits_{k\rightarrow\infty}\sum_{n=0}^k (-1)^n \frac{x^{2n+1}}{(2n+1)!}           \\
            & = x - \frac{x^3}{6} + \frac{x^5}{120} - \dotsb&\\             \\\text{für alle} \ x.\\
    \cos(x) & = \sum_{n=0}^\infty (-1)^n \frac{x^{2n}}{(2n)!}               \\
            & = 1 - \frac{x^2}{2} + \frac{x^4}{24} - \dotsb&\\              \\\text{für alle} \ x.\\
    \tan(x) & = \sum_{n=1}^\infty \frac{B_{2n}(-4)^n(1-4^n)}{(2n)!}x^{2n-1} \\
            & = x + \frac{x^3}{3} + \frac{2 x^5}{15} + \dotsb&\\            \\\text{für } |x| < \frac{\pi}{2}.\\
    \sec(x) & = \sum_{n=0}^\infty (-1)^n \frac{E_{2n}}{(2n)!}x^{2n}         \\
            & = 1 + \frac{x^2}{2} + \frac{5 x^4}{24} + \dotsb&              \\\text{für } |x| < \frac{\pi}{2}.\\\\

    \text{To Do: More of them :3}
  \end{array}\]
